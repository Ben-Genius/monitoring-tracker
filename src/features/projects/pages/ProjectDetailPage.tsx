                ...
                <Card className="border-slate-200/60 shadow-sm">
                    ...
                    <CardContent className="space-y-6">
                        ...
                        <div className="p-4 bg-indigo-50/50 rounded-xl border border-indigo-100">
                            <p className="text-[10px] font-bold text-indigo-500 uppercase tracking-widest mb-2">Internal Note</p>
                            <p className="text-xs text-indigo-700 leading-relaxed font-medium">
                                This project is currently assigned to {project.lead?.name}. All stage transitions require direct approval from the central Admin panel.
                            </p>
                        </div>
                    </CardContent>
                </Card>
